...
static void fast_demo(bool console)
{
    ...
    array img_color;
    // if (console)
    //     // img_color = loadImage("../../smufl-november2-test.jpg", true);
    //     img_color = loadImage("../../image_yuv422.jpg", true);
    // else
    // img_color = loadImage("../../image_uyvy.jpg", true);
    img_color = loadImage("image_uyvy.jpg", true);
        // img_color = loadImage("../../smufl-november2-test.jpg", true);
    ...
    std::cout << "ndims: " << img.dims().ndims() << std::endl;

    features feat;
    array desc;
    float fast_thr = 20.0f;
    unsigned max_feat = 400;
    float scl_fctr = 1.5f;
    unsigned levels = 4;
    bool blur_img = false;
    orb(
